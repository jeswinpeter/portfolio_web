...
import { Home, FolderKanban, Clock3, Mail, User } from 'lucide-react';
...
export function Navbar(): React.JSX.Element {
  return (
    ...
    <motion.nav
      className={`${manrope.className} p-2 rounded-2xl bg-white/60 dark:bg-black/60 backdrop-blur-lg border border-gray-200/80 dark:border-gray-800/80 shadow-lg dark:shadow-gray-900/20 relative overflow-hidden`}
      initial="initial"
      whileHover="hover"
    >
      <motion.div
